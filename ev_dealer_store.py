...
VEHICLE_WRITABLE = {
    ...
    "priority_tags",
    "location",
    "battery_warranty_years_remaining",
    "battery_warranty_km_remaining",
    "photo_urls",
    "battery_certificate",
    "featured",
}
...
def create_buyer_lead_by_slug(
    ...
    *,
    ...
    qualified = bool(
        buyer_email.strip() and buyer_name.strip() and (buyer_postcode.strip() or profile.get("budget_eur"))
    )
        ...
        lead = EvBuyerLead(
            ...
            buyer_profile={
                **profile,
                ...
                "vehicle_label": f"{vehicle.get('make')} {vehicle.get('model')}",
            },
